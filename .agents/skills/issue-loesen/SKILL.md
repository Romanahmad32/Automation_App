...
Auftrag baut auf dem Skill `.Codex/skills/subagent-auftrag/SKILL.md` auf, damit Modellwahl,
...
7. **Doku und Wächter** (Sonnet): `docs/STAND.md`, die zutreffende Regeltabelle (Wurzel-
   `AGENTS.md` oder die des betroffenen Teilbaums), ein Architekturtest, wenn sich die Regel
