...
> Zuerst `Automation_App_Frontend/AGENTS.md` bzw. `AutomationService/AGENTS.md` lesen, je
> nachdem welcher Teilbaum betroffen ist. Dazu die nicht verhandelbaren Regeln aus der
> Wurzel-`AGENTS.md`, eine je Satz: Dateien kurz halten (250 Anweisungszeilen, 450 insgesamt);
