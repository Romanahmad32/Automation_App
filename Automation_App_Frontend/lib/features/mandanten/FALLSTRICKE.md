...
fährt, entscheidet nicht die App (§4.1, #130). Aufgenommen wird der **normalisierte** Wert:
`TexteListenEditor.normalisiere` läuft vor Anmerkung, Dublettenvergleich und Aufnahme.
