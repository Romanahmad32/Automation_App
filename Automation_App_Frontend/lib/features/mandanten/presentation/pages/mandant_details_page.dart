...
import 'package:automation_app/features/mandanten/presentation/widgets/mandant_stammdaten_felder.dart';
...
class _MandantDetailsPageState extends State<MandantDetailsPage> {
  ...
  late final FormGroup _form = FormGroup({
    ...
    'persoenlicheGrussformel': FormControl<String>(
      value: widget.mandant?.persoenlicheGrussformel ?? '',
    ),
  });
    ...
    if (_istBearbeitung) {
      cubit.aktualisiere(
        widget.mandant!.copyWith(
          ...
          notiz: read('notiz'),
          persoenlicheGrussformel: read('persoenlicheGrussformel'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FormSection(
                          ...
                          children: [
                            MandantStammdatenFelder(
                              anrede: _anrede,
                              onAnredeChanged: (wert) => _anrede = wert,
                              kennzeichen: _kennzeichen,
                              onKennzeichenChanged: (werte) =>
                                  _kennzeichen = werte,
                            ),
                          ],
                        ),
